...
public class SliderActivity extends ActionBarActivity
    ...
    @Override
    public void onGoToJikexueyuanBtnClicked() {
        getSupportFragmentManager().beginTransaction().replace(R.id.container,new JikexueyuanWebViewFragment()).commit();
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((SliderActivity) activity).onSectionAttached(
